...
public class Main {
    public static void main(String[] args) {
        Diarista diarista_I = new Diarista(60.0, 20);
        Gerente gerente_I = new Gerente(10_000.00);
        ...
        diarista_II.setSalarioDia(80.0);
        gerente_II.setSalarioMes(20_000.00);
        ...
        Funcionario diarista_III = new Diarista(75.0, 20);
        Funcionario gerente_III = new Gerente(5000.00);
